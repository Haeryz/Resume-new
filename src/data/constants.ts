...
using use = useUsing("use")`,
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "indentation is a personality trait, and we love it 🐍✨",
    color: "#3776ab",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Deliver a comprehensive curriculum on Python, JavaScript, and game development to students aged 7-17, translating complex computer science concepts into engaging, age-appropriate lessons.",
      "Mentor classes of 10+ students through the full software development lifecycle, resulting in 100% of participants completing functional capstone projects such as interactive websites and mobile apps.",
      "Evaluate individual progress through code reviews and logic puzzles, providing personalized feedback that improved student problem-solving skills and maintained a high course retention rate.",
    ],
    skills: [
      SkillNames.PYTHON,
      SkillNames.JS,
  ...
  },
  {
    ...
    description: [
      "Developed “Depo79,” an e-commerce platform for construction retail using the MERN stack and TypeScript with real-time chat (Socket.IO), JWT auth, and a Chart.js analytics dashboard.",
      "Utilized Zustand for state management and Chakra UI for responsive design.",
      "Configured GitHub Actions CI/CD and deployed to Azure Web Services.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.TS,
